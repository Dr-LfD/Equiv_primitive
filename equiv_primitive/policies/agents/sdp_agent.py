...
from equiv_primitive.policies.utils.norm import Normalizer
from equiv_primitive.policies.utils.misc import to_torch, rotate_observation, to_tensor, EQUIV_PRIMITIVE_PATH
from equiv_primitive.policies.utils.diffusion.lr_scheduler import get_scheduler
from equiv_primitive.policies.agents.sdp_policy import SDPPolicy
from equiv_primitive.policies.agents.per_skill_policy import BiopSkillPolicy
...
class SDPAgent:
    ...
    def load_snapshot(self, load_path):
        ...
        import os
        load_path_full = os.path.join(EQUIV_PRIMITIVE_PATH, load_path)
